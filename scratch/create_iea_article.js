...
async function main() {
  // Find or select category for "Temiz Enerji" or "Elektrikli Araçlar"
  ...
  const content = `
<p className="lead font-medium text-xl text-gray-700 mb-6">
...
<h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Küresel Üretim Kapasitesi 4 TWh Barajını Aştı</h2>
<p className="mb-4">
...
<h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Coğrafi Yoğunlaşma ve Çin’in Pazar Hakimiyeti</h2>
<p className="mb-4">
...
<h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Hücre Mimarilerinde Rekabet: Prizmatik, Silindirik ve Kese</h2>
<p className="mb-4">
  Sektördeki teknoloji yarışı üç temel fiziksel hücre yapısı (Form Factor) etrafında şekilleniyor:
</p>
<div className="bg-emerald-50/60 border border-emerald-100 rounded-2xl p-5 my-6 space-y-4">
  <div>
    <h3 className="font-bold text-emerald-900 text-base">🔷 Prizmatik (Prismatic) Hücreler (%60+ Pazar Payı)</h3>
  ...
  <div>
    <h3 className="font-bold text-emerald-900 text-base">🔋 Silindirik (Cylindrical) Hücreler</h3>
    <p className="text-sm text-emerald-800 mt-1">
  ...
  <div>
    <h3 className="font-bold text-emerald-900 text-base">✉️ Kese (Pouch) Hücreler</h3>
    <p className="text-sm text-emerald-800 mt-1">
...
<h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. Tedarik Zincirindeki Hassas Darboğazlar ve Jeopolitik Riskler</h2>
<p className="mb-4">
...
<h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">5. Üretim Maliyetleri: Batı Neden %50 Daha Pahalı?</h2>
<p className="mb-4">
...
`;
  ...
  console.log("SUCCESS: Article published with ID:", article.id);
  console.log("URL: /haber/" + article.slug);
}
