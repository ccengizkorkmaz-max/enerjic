...
async function main() {
  ...
  const articleData = {
    ...
    imageUrl: "/images/articles/elonmusk.png",
    isFeatured: false,
...
[IMG:/images/articles/elonmusk.png|Elon Musk, Tesla'nın ilk meyvesi olan orijinal Roadster ile (2008)]
...
[IMG:/images/articles/tesla-kuruculari.png|Tesla'nın asıl kurucuları: Martin Eberhard (solda) ve Marc Tarpenning (sağda)]
